...
<section class="pt-150 pb-100">
    <div class="container">
        <div class="well">
            <legend class="nomargin noborder">My Profile<small class="pull-right fs12"><a href="/users/my-ads"
                        class="mb20"><i class="fa fa-chevron-circle-left"></i> Back to Dashboard</a> &nbsp;|&nbsp; <a
                        href="/forums/my/preferences"><i class="fa fa-external-link"></i> Edit Forum
                        Settings</a></small></legend>
            <form accept-charset="UTF-8" action="https://www.pakwheels.com/forums/uploads.json" class="form-horizontal"
                ...
                <div class="form-group">
                    <label class="col-md-4 nopad">
                        <div class="profile-photo pull-right"
                            style="background-image: url(https://fcache1.pakwheels.com/original/4X/d/4/3/d43a491f6b82256f266a3bf58b6a47f853c5dd2e.jpeg);">
                        </div>
                    </label>
                    <div class="col-md-8">
                        <input id="api_username" name="api_username" type="hidden" value="junaidmalik14" />
                        <input id="api_key" name="api_key" type="hidden"
                            value="ce0d809e6c670837ef009b9f6c5dffb670e7c79e606de737d8dc049b90e935ff" />
                        <input id="type" name="type" type="hidden" value="avatar" />
                        <input id="producer" name="producer" type="hidden" value="true" />
                        <input id="username" name="username" type="hidden" value="ahmadijaz385" />
                        <input id="user_id" name="user_id" type="hidden" value="4005629" />
                        <input id="file" name="file" onchange="$(&#39;#upload-avatar&#39;).submit();" type="file" />

                    </div>
                </div>
            </form>
            <hr />
            <form accept-charset="UTF-8" action="/users/4005629" class="form-horizontal edit-user-profile-validation"
                data-parsley-validate="" enctype="multipart/form-data" id="edit_user_4005629" method="post">
                <div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden"
                ...
                <fieldset>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input data-parsley-error-message="Enter valid full name" data-parsley-length="[3,25]"
                                ...
                                name="user[display_name]" placeholder="Full Name" size="30" type="text"
                                value="Ahmad Ijaz" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div id="datetimepicker" class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar" data-time-icon="fa fa-clock-o"
                                        data-date-icon="fa fa-calendar"></i></span>
                                <input data-behaviour="datepicker" data-format="dd-MM-yyyy"
                                    data-parsley-pattern="^\d{2}-\d{2}-\d{4}$" id="user_birthday" name="user[birthday]"
                                    placeholder="DD-MM-YYYY" size="30" type="text" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="user_country" name="user[country]" onchange="onCountryDDChange();">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input data-parsley-length="[3,50]"
                                data-parsley-pattern-message="Invalid username. You can only use lowercase letters, numbers, periods(.), underscores(_), hyphens(-)"
                                data-parsley-pattern="^[a-z0-9]+([._-]?[a-z0-9]+)+$"
                                data-parsley-remote-validator="validateUsername" data-parsley-remote="1"
                                data-parsley-required="true" data-parsley-trigger="change" id="user_username"
                                name="user[username]" onchange="$(&#39;.parsley-errorField&#39;).remove();"
                                onkeyup="toLower($(this))" placeholder="Username" size="30" type="text"
                                value="ahmadijaz385" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input data-parsley-length="[6,50]" data-parsley-remote-validator="validateEmail"
                                data-parsley-remote="1" data-parsley-required="true" data-parsley-trigger="change"
                                data-parsley-type="email" id="user_email" maxlength="50" name="user[email]"
                                onchange="$(&#39;.parsley-errorField&#39;).remove();" placeholder="Email Address"
                                size="50" type="text" value="ahmadijaz385@gmail.com" />
                ...
                <fieldset>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="well well-small" id="well_list_mobile" style='display:none;'>
                                <table id="tbl_list_mobile" class="table table-striped nomargin">
                                    <thead>
                                        <tr>
                                            <th>Number</th>
                                            <th>Status</th>
                            ...
                            <a href="javascript:;" class="btn btn-primary btn-small mt5" id="a_add_number"
                                onclick="showAddMobileForm();"><i class='fa fa-plus-sign'></i> Add Number</a>
                            <div id="frm_mobile_number" class="well well-small mobile-number mt10"
                                style="display:none;">
                                <p>Type in your number and click verify to receive the sms code</p>
                                <input id="mobile_number" maxlength="12" name="mobile_number" type="text" value="" />
                                <a href="javascript:" class="btn btn-success mt10"
                                    onclick="editProfileVerifyNumber(&#39;#ver-num-loading&#39;);">verify by sms</a>
                                <img alt="Loading_icon" class="pull-right" id="ver-num-loading"
                                    src="https://wsa2.pakwheels.com/assets/loading_icon-7908fe6f50615d7f01fd949d1c713d4d.gif"
                                    style="display:none;" />
                                <div class="clearfix"></div>
                                <div id="new_number_message" style="color:red;"></div>
                            </div>
                            <div class="well well-small mobile-number mt10" id="box_mobile_number_verify"
                                style="display:none;">
                                <p>We'll send a verification code in the next few minutes to <b
                                        id='ver-phone'>03001234567</b>. Please enter it in the box below. Enter
                                    authentication code below</p>
                                <input class="ver-code" id="verification_code" maxlength="6" name="verification_code"
                                    type="text" value="" />
                                <input id="current_number" name="current_number" type="hidden" value="" />
                                <input id="current_uuid" name="current_uuid" type="hidden" value="" />
                                <div class="clearfix"></div>
                                <a href="javascript:" class="btn btn-success mt10" id="a_verify_code"
                                    onclick="profileVerify(&#39;#ver-num-loading-verify&#39;);">Verify</a>
                                <a href="javascript:" class="btn btn-inverse mt10" id="a_resend_code"
                                    onclick="resendVerificationCode(&#39;#ver-num-loading-verify&#39;);$(&#39;#verify_number_message&#39;).empty();">Resend</a>
                                <a href="javascript:" class="btn btn-link mt10"
                                    onclick="$(&#39;#box_mobile_number_verify&#39;).fadeOut(&#39;slow&#39;);$(&#39;#verify_number_message&#39;).empty();$(&#39;#a_add_number&#39;).fadeIn(&#39;slow&#39;);">Cancel</a>
                                <span id="ver-num-loading-verify" style="display:none">
                                    <img alt="Loading_icon"
                                        src="https://wsa2.pakwheels.com/assets/loading_icon-7908fe6f50615d7f01fd949d1c713d4d.gif" />
                                </span>
                                <div id="verify_number_message_success" style="color:green;"></div>
                                <div id="verify_number_message_error" style="color:red;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group sell-btn-main">
                        <div class="col-md-offset-4 col-md-8">
                            <input class="btn btn-primary btn-large fs16" name="commit" type="submit"
                                value="Save Changes" />
                        </div>
                    </div>
                </fieldset>
                ...
                <hr />
                <div class="form-group linked-accounts">
                    <label class="col-md-4">Linked Account</label>
                    <div class="col-md-8">
                        <a href="/oauth/facebook" class="btn btn-social facebook" id="connect-facebook"><i
                                class='fa fa-facebook'></i> Connect with Facebook</a>
                        <a href="javascript:;" class="btn btn-social facebook" id="disconnect-facebook"
                            onclick="disconnectFacebook(&#39;4005629&#39;);" style="display:none;"><i
                                class='fa fa-facebook'></i> Disconnect from Facebook</a>
                ...
                <div class="row">
                    <div class="col-md-6 why-login-left">
                        ...
                        <ul class="list-unstyled login-points-list">
                            <li>
                                <img class="pull-left"
                                    src="https://lite1.pakwheels.com/staging/app/3.4.104/assets/images/login-point-1.png" />
                                <h4>Safely Connect with Buyers</h4>
                                <p>You can connect with thousands of buyers and quick search</p>
                            </li>
                            <li>
                                <img class="pull-left"
                                    src="https://lite1.pakwheels.com/staging/app/3.4.104/assets/images/login-point-2.png" />
                                <h4>Create Quick Alerts</h4>
                                <p>Create alerts quickly and get notified when new listing become available</p>
                            </li>
                            <li>
                                <img class="pull-left"
                                    src="https://lite1.pakwheels.com/staging/app/3.4.104/assets/images/login-point-3.png">
                        ...
                        <div class="registration-page registration-panel" style="min-height: auto;">
                            <div class="registration-span">
                                ...
                                <a href="/oauth/google" class="btn btn-block btn-social google"
                                    ...
                                    onclick="trackEvents(&#39;Login&#39;,&#39;viaGoogle&#39;,&#39;users - edit&#39;)"><i
                                        class='fa fa-google'></i> Continue with Google</a>

                                <a href="/oauth/facebook" class="btn btn-block btn-social facebook"
                                    data-login-method="SignInWithFacebook"
                                    onclick="trackEvents(&#39;Login&#39;,&#39;viaFacebook&#39;,&#39;users - edit&#39;)"><i
                                        class='fa fa-facebook2'></i> Continue with Facebook</a>
                                <div class="fb-faces" style="margin: auto;width: 300px">
                                    <span class="fb-facepile" data-app-id="139280839547845" data-width="300px"
                                        data-height="28" data-max-rows="1" data-colorscheme="light" data-size="small"
                                        data-show-count="true"></span>
                                    <div id="fb-root"></div>
                                    <p></p>
                                </div>

                                <a href="/login" class="btn btn-block btn-social with-email"
                                    data-login-method="SignInWithEmail"
                                    onclick="trackEvents(&#39;Login&#39;,&#39;viaEmail&#39;,&#39;users - edit&#39;)"><i
                                        class='fa fa-envelope'></i> Continue with Email</a>
                                <input id="intent_url" name="intent_url" type="hidden"
                                    value="https://www.pakwheels.com/users/4005629/edit" />
