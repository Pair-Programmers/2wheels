...
@section('title')
<title> My Product Adds - 2Wheels</title>
@endsection
@section('contents')
<style>
                                        ...
                                        <div id="gallery-5362814">
                                            <div id="contact-user-info-5362814" class='custom-html'
                                                ...
                                                <div class="light-gallery-user-info clearfix">
                                                    <strong class="generic-white fs18">PKR {{$product->price}}</strong>
                                                </div>
                                            </div>
                                    ...
                                    <div class="search-bottom">
                                        <div class="">
                                            <div class="quantizer-info links-container pull-right mr5 clearfix">
                                                <a href="{{route('product.destroy', $product->id)}}" class="btn btn-secondary pull-right gtm-buynow">Delete</a>
                                                <a href="{{route('product.edit', $product->id)}}" class="btn btn-link-outline btn-danger pull-right mr5 add-cart-item">edit</a>
                                            </div>
                                            <div>
