                    ...
                    <div class="vehicle-model-0 list-unstyled item active clearfix">
                        ...
                        @endphp
                            <ul class="make-list col-sm-2 list-unstyled new-car-list">
                                <li class="heading">
                                    <a href="{{route('used_bike_by_make', $company->id)}}" id="amk_honda" title="Honda Bike in Pakistan">
                                ...
                                <li><a href="{{route('used_bike_by_model', $model->id)}}" id="amd_Honda,CG 125" title="{{$company->name}} {{$model->name}}"
        ...
        <div class="container">
            ...
            <div class="">
                <ul class="browse-listing row">
                    <li class="col-sm-2">
                        <a href="{{route('used_bike_body_type', 'Standard')}}" class="shadow-box show" data-category-name=""
                            title="Standard Bikes for sale in Pakistan">
                    ...
                    <li class="col-sm-2">
                        <a href="{{route('used_bike_body_type', 'Heavy Bike')}}" class="shadow-box show" data-category-name=""
                            title="Heavy Bikes for sale in Pakistan">
                    ...
                    <li class="col-sm-2">
                        <a href="{{route('used_bike_body_type', 'Sports Bike')}}" class="shadow-box show" data-category-name=""
                            title="Sports Bikes for sale in Pakistan">
                    ...
                    <li class="col-sm-2">
                        <a href="{{route('used_bike_body_type', 'Dirt Bike')}}" class="shadow-box show" data-category-name=""
                            title="Dirt Bikes for sale in Pakistan">
                    ...
                    <li class="col-sm-2">
                        <a href="{{route('used_bike_body_type', 'ATV')}}" class="shadow-box show" data-category-name=""
                            title="ATV Bikes for sale in Pakistan">
                    ...
                    <li class="col-sm-2">
                        <a href="{{route('used_bike_body_type', 'Chopper')}}" class="shadow-box show" data-category-name=""
                            title="Chopper for sale in Pakistan">
                    ...
                    <li class="col-sm-2">
                        <a href="{{route('used_bike_body_type', 'Scooter')}}" class="shadow-box show" data-category-name=""
                            title="Scooty Bike for sale in Pakistan">
                    ...
                    <li class="col-sm-2">
                        <a href="{{route('used_bike_body_type', 'Trail')}}" class="shadow-box show" data-category-name=""
                            title="Trail Bikes for sale in Pakistan">
                ...
                <div id="browse-by-city-carousel" class="carousel slide lazy-slider browse-left" data-ride="carousel"
                    ...
                    <div class="carousel-inner">
                        ...
                        <ul class="browse-listing item active browse-auto-link clearfix" id="browse-by-city-bike">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Karachi')}}" id="ct_karachi" title="Bikes for sale in Karachi">
                                    Karachi
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Multan')}}" id="ct_multan" title="Bikes for sale in Multan">
                                    Multan
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Sialkot')}}" id="ct_sialkot" title="Bikes for sale in Sialkot">
                                    Sialkot
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Attock')}}" id="ct_attock" title="Bikes for sale in Attock">
                                    Attock
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Gujrat')}}" id="ct_gujrat" title="Bikes for sale in Gujrat">
                                    Gujrat
                                </a>
                            </li>
                            <li class="col-md-3">
                        ...
                        <ul class="browse-listing item  browse-auto-link clearfix" id="browse-by-city-bike">
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Chakwal')}}" id="ct_chakwal" title="Bikes for sale in Chakwal">
                                    Chakwal
                                </a>
                            </li>
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Mardan')}}" id="ct_mardan" title="Bikes for sale in Mardan">
                                    Mardan
                                </a>
                            </li>
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Quetta')}}" id="ct_quetta" title="Bikes for sale in Quetta">
                                    Quetta
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Sahiwal')}}" id="ct_sahiwal" title="Bikes for sale in Sahiwal">
                                    Sahiwal
                                </a>
                            </li>
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Jehlum')}}" id="ct_jehlum" title="Bikes for sale in Jehlum">
                                    Jehlum
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Okara')}}" id="ct_okara" title="Bikes for sale in Okara">
                                    Okara
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Jhang')}}" id="ct_jhang" title="Bikes for sale in Jhang">
                                    Jhang
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Sukkur')}}" id="ct_sukkur" title="Bikes for sale in Sukkur">
                                    Sukkur
                                </a>
                            </li>
                            <li class="col-md-3">
                            ...
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Taxila')}}" id="ct_taxila" title="Bikes for sale in Taxila">
                                    Taxila
                                </a>
                            </li>
                            <li class="col-md-3">
                                <a href="{{route('used_bike_by_city', 'Chiniot')}}" id="ct_chiniot" title="Bikes for sale in Chiniot">
                                    Chiniot
                                </a>
                            </li>
                        </ul>
        ...
        <div class="container">
            ...
            <table cellpadding="0" cellspacing="0" width="100%"
                ...
                <tr id="browse-by-price-range-bike">
                    <td><a href='{{route('used_bike_by_price', 1)}}' rel='nofollow'
                            id='searchby_Below-2-tho' title=' Used Bikes for Sale - Below 20 thousands'>
                            <span class='seats'>
                    ...
                    <td><a href='{{route('used_bike_by_price', 2)}}' rel='nofollow'
                            id='searchby_2-to-4-tho' title=' Used Bikes for Sale - 20 to 40 thousands'>
                            <span class='seats'>
                    ...
                    <td><a href='{{route('used_bike_by_price', 3)}}' rel='nofollow'
                            id='searchby_4-to-6-tho' title=' Used Bikes for Sale - 40 to 60 thousands'>
                            <span class='seats'>
                    ...
                    <td><a href='{{route('used_bike_by_price', 4)}}' rel='nofollow'
                            id='searchby_6-to-10-tho' title=' Used Bikes for Sale - 60 to 100 thousands'>
                            <span class='seats'>
                    ...
                    <td><a href='{{route('used_bike_by_price', 5)}}' rel='nofollow'
                            id='searchby_10-to-14-tho' title=' Used Bikes for Sale - 100 to 140 thousands'>
                            <span class='seats'>
                    ...
                    <td><a href='{{route('used_bike_by_price', 6)}}' rel='nofollow'
                            id='searchby_Above-14-tho' title=' Used Bikes for Sale - Above 140 thousands'>
                            <span class='seats'>
