                                    ...
                                    <div>
                                        <div class="search-title-row">
                                            <div class="search-title">
                                                ...
                                                <a href="{{route('bike.show', $bike->bike->id)}}" class="car-name ad-detail-path"
                                                    title='Universal PVC Plastic Car Mat - Black  in Karachi'
                                                    current-index='0' target='_blank'>
                                                    <h3>{{$bike->bike->model_year}} {{$bike->bike->model->name}} {{$bike->bike->company->name}}</h3>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="search-bottom">
                                        <div class="">
                                            <div class="quantizer-info links-container pull-right mr5 clearfix">
                                                <a href="" class="btn btn-link-outline btn-danger pull-right mr5 add-cart-item">Remove</a>
