        ...
        <div class="remove-section">
            ...
            <section>
                <div class="container">
                    ...
                    <form accept-charset="UTF-8" action="{{ route('bike.update', $bike->id) }}"
                            ...
                            <div class="well">
                                <fieldset class="nomargin sell-form">
                                    ...
                                    {{-- <div class="form-group mt20">
                                        ...
                                        <div class="col-md-5">
                                            <input id="bike_selector" name="name" placeholder="" style="width:100%;" type="text" value="{{$bike->name}}"
                                                required />
                                        </div>
                                    ...
                                    <div class="form-group mt20">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <script>
                                                ...
                                                modelSelect.value = `{{$bike->model_id}}`;
                                            </script>
                                        </div>
                                    ...
                                    <div class="form-group mt20">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <script>
                                                let modelSelect = document.getElementById('model_year');
                                                modelSelect.value = `{{$bike->model_year}}`;
                                            </script>
                                        </div>
                                    ...
                                    <div class="form-group mt20">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <script>
                                                let modelSelect = document.getElementById('body_type');
                                                modelSelect.value = `{{$bike->body_type}}`;
                                            </script>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5 car-select-parent">
                                            <input id="bike_selector" name="description" placeholder="" type="text" value="{{$bike->description}}"
                                                class="w-100" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <script>
                                                let modelSelect = document.getElementById('used_bike_reg_city_id');
                                                modelSelect.value = `{{$bike->reg_city_id}}`;
                                            </script>
                                ...
                                <fieldset>
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group p-0" style="margin-left:-213px;margin-top:10px">
                                                    ...
                                                    <input class="w-100"
                                                        ...
                                                        name="mileage" placeholder="Mileage" type="number" value="{{$bike->mileage}}"
                                                        required />
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5" style="margin-left:-213px;margin-top:10px">
                                                <select data-parsley-error-message="Please select engine type"
                                                    ...
                                                    id="assaused_bike_engine_type" name="engine_type" required>
                                                ...
                                                <script>
                                                    let enginSelect = document.getElementById('assaused_bike_engine_type');
                                                    enginSelect.value = `{{$bike->engine_type}}`;
                                                </script>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5" style="margin-left:-213px;margin-top:10px">
                                            ...
                                            <script>
                                                let modelSelect = document.getElementById('used_bike_ca');
                                                modelSelect.value = `{{$bike->category}}`;
                                            </script>
                                        </div>
                                    </div>
                            ...
                            <fieldset>
                                <div class="well">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input id="bike_selector" name="price" placeholder="" type="number" value="{{$bike->price}}"
                                                required />
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-hint">
                                            ...
                                            <ul class="list-unstyled list-inline sell-feature-list col-12">
                                                ...
                                                <li>
                                                    <label class="d-flex align-items-center"><input name="additional_info[]"
                                                            type="hidden" value="0" /><input @if(json_decode($bike->additional_info)[1] != 0) checked @endif style="height: 15px;"
                                                            id="used_bike_disc_break" name="additional_info[]"
                                                            type="checkbox" value="Disc Brake" />
                                                        <span style="width: 22vw;">Disc Brake</span></label>
                                                </li>
                                                <li>
                                                    <label class="d-flex align-items-center"><input @if(json_decode($bike->additional_info)[2] != 0) checked @endif id="used_bike_led_light"
                                                ...
                                                <li>
                                                    <label class="d-flex align-items-center"><input name="additional_info[]"
                                                            type="hidden" value="0" /><input @if(json_decode($bike->additional_info)[3] != 0) checked @endif style="height: 15px;"
                                                            id="used_bike_wind_shield"
                            ...
                            <fieldset>
                                <div class="well">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    <input class="prefilled" data-parsley-error-message="Enter valid name"
                                                        ...
                                                        required value="{{$bike->seller_name}}" />
                                                </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <input class="ad-mobile-number prefilled"
                                                    ...
                                                    type="number" value="{{$bike->seller_phone}}" required />
                                            </div>
                                    ...
                                    <div class="form-group secondary-phone">
                                        ...
                                        <div class="col-md-9">
                                            <input name="seller_address" required value="{{$bike->seller_address}}" type="text" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group secondary-phone">
                                        <label class="col-md-3" for="second_phone" class="note">Comment <span
                                                class="optional"></span></label>
                                        <div class="col-md-9">
                                            <input name="seller_comment" value="{{$bike->seller_comment}}" type="text" />
                                        </div>
                                    </div>
