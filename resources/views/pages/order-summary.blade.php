    ...
    <div class="remove-section">
        ...
        <div class="container">
            <table class="table order-steps table-fixed text-center mb0" width="100%">
                <tr>
                    <td class="active" id="order-summary-tab">
        ...
        <section id="order-summary">
            <div class="container">
                <div class="well p20 mb0">
                    <p class="mb0"> You have <strong><span id='total-items-count'> 1 </span></strong>
                        <strong>items</strong> in your cart
                    </p>
                    <div class="checkout-error-container hide"></div>
                </div>

                <table class="table table-striped table-bordered table-order mt-1 mb0" width="100%">
                    <tbody>
                        <tr class="generic-blue">
                            <th>Item</th>
                ...
                <table class="table table-striped table-bordered table-order mt-1 mb0" width="100%">
                    ...
                    @foreach ($cart->getContents() as $product)
                        <tr>
                            <td class="text-left-i">
                                <div class="table-order-img">
                                    ...
                                    <div class="title">
                                        <a href="/accessories-spare-parts/5d-custom-floor-mats-black-for-honda-civic-2006-2012-4503606"
                                            class="show" target="_blank">{{$product['product']->name}}</a>
                                        <div>
                                            <span class="shiping-fee-tag show-last">Shipping: PKR <span
                                                    class="dealer_id_17463">0</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td width="160">PKR {{$product['product']->price}}
                            <td width="160">

                                    {{-- <button type="button" class="btn pull-left" id="quantity-minus-1182479"
                                        field='quantity'
                                        onclick="quantityMultiplierForPrice('#quantity-minus-1182479','3750','#total-price-1182479','decrement','#quantity-unit-1182479','13886328','4503606','','#discount','#discount_amount','#discount_type')">
                                        <i class="fa fa-minus"></i></button> --}}
                                        <form action="{{url('/update_cart')}}" method="POST">
                                            @csrf
                                    <input type='number' class="w-75"  value="{{$product['qty']}}" name='quantity' />
                                    <input type='hidden' class="w-75"  value="{{$product['product']->id}}" name='product_id' />
                            ...
                            <td width=160 align="center">
                                <input type='text' id="total-price-1182479" value="{{$product['price']}}"
                                    class="net-total-sum order-count generic-green" disabled />
                            </td>

                            <td width="140">
                                <a href="{{url('remove_product_from_cart/'.$product['product']->id)}}"
                                    class="generic-red">
                                    Remove
                                </a>
                            </td>
                        ...
                        @endforeach
                        @else
                        <div class="alert alert-danger text-center"><span class="" >Empty</span></div>
                        @endif


                    </tbody>
                </table>
                <table class="table table-striped table-bordered table-order mt-1" width="100%">
                    <tbody>
                        <tr>

                            <td colspan=2>
                                <div class="text-right fs16">
                                    Items Total :
                                    <strong>PKR </strong><strong id="item-net-total">@if(Session::has('cart')){{$cart->getTotalPrice()}}@else 0 @endif</strong>
                                </div>
                                <hr class="mt15 mb15">

                                <div class="text-right fs16 generic-blue">
                                    Shipping charges : <span id="shipping_charges"> 0 </span>
                                </div>
                                ...
                                <div class="generic-green fs18 text-right">
                                    Grand Total :<strong class="fs20"> PKR
                                        <span id="net-total-with-shipping">@if(Session::has('cart')){{$cart->getTotalPrice()}}@else 0 @endif</span></strong>
                                </div>

                            </td>
                        </tr>
                        <tr>
                            <td colspan="5" class="checkout-footer">
                                <a href="{{url('/shipping-info')}}" class='btn btn-primary  pull-right'>
                                    Shipping Info
                                </a>
                            </td>
                        </tr>
        ...
        <section id="shipping-info-non-logged-in" style="display:none">
            <div class="container">
                <div class="well mb0 text-center mb40">
                    <h3 class="fs18 mt0 mb5">Your info</h3>
                    <p>Proceed to your order by following methods</p>
                    <div class="row">
                        <div class="col-sm-4 col-sm-offset-4">
                            <p class="mt15">
                                <button class="btn btn-primary btn-block btn-lg ttn"
                                    onclick="setDiscountCodeCookie();trackEvents('User', 'LoginClickedOnCheckout', 'SignIn');"
                                    data-toggle="modal" data-target="#sign-in">Sign in to Proceed</button>
                            </p>
                            <p class="mt15 mb15">
                                <button class="btn btn-secondary btn-block btn-lg ttn"
                                    onclick="setDiscountCodeCookie();trackEvents('User', 'LoginClickedOnCheckout', 'SignUp');"
                                    data-toggle="modal" data-target="#sign-up">Create new account</button>
                            </p>
                            <a href="#" class="learn-more"
                                onclick="$('#shipping-info').show();$('#shipping-info-non-logged-in').hide();trackEvents('User', 'LoginClickedOnCheckout', 'GuestCheckout');">
                                <strong class="fs16">Checkout as guest</strong>
                            </a>
                        </div>
                    </div>

                    <div class="checkout-footer row-placer mt30 clearfix">
                        <button class="checkout-back pull-left" name="button" onclick="showOrderSummary();"
                            type="button"><i class='fa fa-angle-left'></i> Order Summary</button>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="well mb20 clearfix">
                            ...
                            <div class="col-sm-6">
                                ...
                                <fieldset class="nomargin pos-rel car-loan-divider shipping-divider">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input data-parsley-pattern-message="Please enter at least 3 alphabets."
                                                ...
                                                name="order[name]" placeholder="Full Name" size="25" type="text"
                                                value="Ahmad Ijaz" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input class="ad-mobile-number"
                                                ...
                                                name="order[phone]" placeholder="Mobile Number" size="11" type="tel" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <textarea cols="2" id="order_comments" name="order[comments]"
                                ...
                                <fieldset class="nomargin pos-rel">
                                    ...
                                    <div class="form-group" id="order-city" style=>
                                        ...
                                        <div class="col-md-7  shipping-info-right">
                                            <select class="chzn-select" data-parsley-required="true"
                                                data-parsley-trigger="change" id="order_city_id" name="order[city_id]">
                        ...
                        <div class="checkout-footer row-placer mt30 clearfix">
                            <button class="checkout-back pull-left" name="button" onclick="showOrderSummary();"
                                type="button"><i class='fa fa-angle-left'></i> Order Summary</button>
                            <button class="btn btn-primary pull-right" name="button"
                                onclick="trackEvents(&#39;Accessories&#39;,&#39;PlaceOrder&#39;,&#39;accessory detail&#39;);"
                                type="submit">Proceed To Payment Method <i class='fa fa-angle-right ml10 fs20'
                                    style='vertical-align:-3px'></i></button>
                        </div>
