...
<head>
    ...
    <title>2Wheels | Product Category Edit</title>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{route('product_category.update', $category->id)}}" enctype="multipart/form-data">
                                @csrf
