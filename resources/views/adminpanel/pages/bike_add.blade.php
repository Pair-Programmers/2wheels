        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{route('admin.bike.store')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="model_year" required>
                                                @for ($i = 1940; $i < 2022; $i++)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="reg_city_id" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="i-checks">
                                            <label> <input type="checkbox" value="Disc Brake" name="additional_info[]" > <i></i>Disc Brake</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="i-checks">
                                            <label> <input type="checkbox" value="Led Light" name="additional_info[]" > <i></i>LED Light</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="i-checks">
                                            <label> <input type="checkbox" value="Wind Shield" name="additional_info[]" > <i></i>Wind Shield</label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="seller_phone" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="seller_comment" >
                                    </div>
